...
function QueriesRecevied(props) {
  ...
  useEffect(() => {
    const getSubmittedAssingment = () => {
      axios
        .get(`${baseUrl}/admin/getQueryDetails?id=${id}`, myConfig)
        .then((res) => {
          if (res.data.code === 1) {
            ...
            if (res.data.result[0].status == "Declined Query") {
              let a = res.data.result[0].declined_date
                .split(" ")[0]
                .split("-")
                .reverse()
                .join("-");
            ...
            if (res.data.proposal_queries.length > 0) {
              ...
              setDisplayProposal({
                ...
                sub_payment_plane:
                  res.data.proposal_queries[0].sub_payment_plane,
                amount_outstanding:
                  res.data.proposal_queries[0].amount_outstanding,
              });
