          ...
          <Container maxWidth="xl">
            <Card>
              <CardHeader
                title={
                  <>
                    <h4 style={{ fontWeight: "800", color: "#4472c4" }}>
                      Mazars Advisory Solutions (MAS){" "}
                    </h4>
                    <span className="modalTextHeading"> visit : </span>
                    <a href="https://masindia.live/" target="_blank">
                      https://masindia.live/
                    </a>
                  </>
                }
            ...
            <Card>
              ...
              <CardContent>
                ...
                <Typography variant="body2" style={{ color: "#0000ff" }}>
                  (On clicking sign up for registration, following screen will
                  open to enter basic information.)
                </Typography>
            ...
            <Card>
              <CardContent>
                <Typography variant="body1" className="modalText">
                  ...
                  Success message will appear. Click ok and enter the OTP to
                  register & click on
                  <Button variant="contained" className={classes.root}>
                    Submit
                  </Button>
                ...
                <Box my={2}>
                  <Typography variant="body1" className="modalText">
                    If the OTP entered is incorrect then Error message window
                    will appear showing “Incorrect OTP, please try again
                  </Typography>
                </Box>
