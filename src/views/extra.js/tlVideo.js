...
schdrularName;
  ...
  handleExit = async() => {
    ...
    .then(response => this.setState( {articleId : response.data.serverResponse.fileList, ...this.state.articleId}),
    this.setState({articleId2 : this.state.articleId, ...this.state.articleId}),
      // this.allrecording.push(json),
      this.setState({showRecBtn : true}))
      .catch((error) => {
    ...
    return (
      ...
      <div id="ag-canvas" style={style}>   
        ...
        isOpen={this.state.showModal}
         ...
         allrecording = {this.state.articleId2}
         />
