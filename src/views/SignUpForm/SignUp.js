...
import MyPDF from "../dFile/signUp.pdf";
...
function SignUp(props) {
  ...
  const onSubmit = (value) => {
    if (!dstate && estate.length < 1) {
      ...
      {
        cityState2 && cityState2.length > 0
          ? formData.append("city", cityState2)
          ...
          .then(function (response) {
            if (response.data.code === 1) {
              ...
              Alerts.SuccessNormal(
                "As per your request , OTP has been sent to your email address and mobile number."
              );
            } else if (response.data.code === 0) {
              setLoading(false);
      ...
      <OuterloginContainer>
        ...
        <MyContainer>
          <div className="form">
            ...
            >
              <CustomHeading>Client registration</CustomHeading>
              <a href={MyPDF} className="tabHover" target="_blank">
                {" "}
                <HelpIcon />{" "}
              </a>
            </div>
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="mb-3" style={{ position: "relative" }}>
                        ...
                        >
                          <GrStatusInfo
                            style={{ visibility: "hidden", zIndex: 99999 }}
                          />
                        </span>
                        {userError.length > 0 ? (
...
representative or authorized signatory, who is registering for query.`}
                    ...
                    <div className="col-md-6">
                      <div className="mb-3">
                        <label className="form-label">
                          Country<span className="declined">*</span>
                        </label>
                        <select
                          id="state"
                          name="p_country"
                    ...
                    <div className="col-md-6">
                      <div className="mb-3">
                        <label className="form-label">
                          State<span className="declined">*</span>
                        </label>
                    ...
                    <div className="col-md-6">
                      <div className="mb-3">
                        <label className="form-label">
                          City<span className="declined">*</span>
                        </label>
                    ...
                    <div className="col-md-6">
                      <div className="mb-3" style={{ position: "relative" }}>
                        <label className="form-label">
                          Mobile number<span className="declined">*</span>
                        </label>
                    ...
                    <div className="col-md-6">
                      <div className="mb-3" style={{ position: "relative" }}>
                        <label className="form-label">
                          Zipcode<span className="declined">*</span>
                        </label>
                        <input
                          type="text"
                          className={classNames("form-control", {
                        ...
                        <span
                          ...
                          title="Enter the valid Zip Code or Pin Code."
                        >
                          <GrStatusInfo
                            style={{ visibility: "hidden", zIndex: 99999 }}
                          />
...
and number.`}
                    ...
                    <div className="col-md-6">
                      <div className="mb-3" style={{ position: "relative" }}>
                        ...
                        <i
                          className={`fa ${
                            repassword ? "fa-eye-slash" : "fa-eye"
                          } password-icon`}
...
to work on the queries under the User Id code.`}
                    ...
                    <div className="col-md-12">
                      <label>
                        Choose a password that should be minimum of eight
                        characters, including at least one upper case, lower
                        case, special character and number
                      </label>
                      <div className="row">
                        <div className="col-md-6">
                          ...
                          {wEmailmulti ? (
                            <p className="declined">{wEmailmulti}</p>
                          ) : (
                            <>
                              {valiEmailMulti ? (
                                <p className="completed">{valiEmailMulti}</p>
                              ) : (
